...
import {
  addTileToAllowedInItsNeighbours,
  collapseTile,
  uncollapseTile,
} from "../../wfc/WfcTilePlacer.ts"; // Define a type for the slice state
...
export const wfcSlice = createSlice({
  ...
  reducers: {
    ...
    addTileToAllowedInItsNeighbours: (
      ...
      if (state.ruleSet == null || state.wfcData == null) {
        return state;
      }
      addTileToAllowedInItsNeighbours(
        col,
